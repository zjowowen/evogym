...
class PackageBase_12_Info(BenchmarkBase):
    ...
    def reset(self):
        ...
        obs = self.get_obs(robot_pos_final, robot_vel_final, package_pos_final, package_vel_final)
        obs = np.concatenate((
            robot_pos_final[:,:2].flatten(),
            robot_vel_final[:,:2].flatten(),
            package_pos_final[:,:1].flatten(),
            package_vel_final[:,:1].flatten(),
        ))

        return obs


class PackageBase_22_Info(BenchmarkBase):
    ...
    def reset(self):
        ...
        obs = self.get_obs(robot_pos_final, robot_vel_final, package_pos_final, package_vel_final)
        obs = np.concatenate((
            robot_pos_final[:,:4].flatten(),
            robot_vel_final[:,:4].flatten(),
            package_pos_final[:,:2].flatten(),
            package_vel_final[:,:1].flatten(),
        ))
...
class PackageBase_88_Info(BenchmarkBase):
    ...
    def reset(self):
        ...
        obs = self.get_obs(robot_pos_final, robot_vel_final, package_pos_final, package_vel_final)
        obs = np.concatenate((
            robot_pos_final[:,:16].flatten(),
            robot_vel_final[:,:16].flatten(),
            package_pos_final[:,:6].flatten(),
            package_vel_final[:,:6].flatten(),
        ))
...
class CarrySmallRect_12_Info(PackageBase_12_Info):
    ...
    def __init__(self, body, connections=None):
        ...
        # init sim
        PackageBase_12_Info.__init__(self, self.world)
        ...
        self.action_space = spaces.Box(low= 0.6, high=1.6, shape=(num_actuators,), dtype=np.float)
        self.observation_space = spaces.Box(low=-100.0, high=100.0, shape=(64,), dtype=np.float)
...
class CarrySmallRect_22_Info(PackageBase_22_Info):
    ...
    def __init__(self, body, connections=None):
        ...
        # init sim
        PackageBase_22_Info.__init__(self, self.world)
...
class CarrySmallRect_88_Info(PackageBase_88_Info):
    ...
    def __init__(self, body, connections=None):
        ...
        # init sim
        PackageBase_88_Info.__init__(self, self.world)
